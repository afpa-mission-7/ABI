...
--
-- Host: localhost
-- Generation Time: Oct 22, 2020 at 09:58 PM
...
INSERT INTO `collaborator` (`id`, `username`, `password`, `firstname`, `lastname`, `function`, `phone`, `email`, `contract`, `status`, `qualification`, `salary`, `photo`, `address`) VALUES
(5, 'ChantalMa', 'Chantal', 'Chantal', 'Marion', 'Directeur administratif', '0647250720', 'chantal.marion@abi.fr', 'CDI', NULL, NULL, 98500, NULL, '367, place Hamel\n01714 Dijoux'),
(6, 'DominiqueAr', 'Dominique', 'Dominique', 'Arnaud', 'Directeur général', '0674766318', 'dominique.arnaud@abi.fr', 'CDI', NULL, NULL, 117000, NULL, 'chemin de Martinez\n16572 Nicolasnec'),
(7, 'RogerEv', 'Roger', 'Roger', 'Evrard', 'Directeur financier', '0699279064', 'roger.evrard@abi.fr', 'CDI', NULL, NULL, 105800, NULL, 'rue de Muller\n37 169 Ribeiro-les-Bains'),
(8, 'AurélieMa', 'Aurélie', 'Aurélie', 'Masse', 'Responsable des ressources humaines', '0695750429', 'aurélie.masse@abi.fr', 'CDI', NULL, NULL, 82200, NULL, '845, rue Maurice Lefebvre\n25 656 Breton'),
(9, 'OcéaneSa', 'Océane', 'Océane', 'Salmon', 'Secrétaire administratif', '0622823450', 'océane.salmon@abi.fr', 'CDI', NULL, NULL, 45000, NULL, '61, avenue Denis Moreno\n99670 Chauveau'),
(10, 'ColetteBa', 'Colette', 'Colette', 'Barthelemy', 'Respoonsable commercial', '0630135964', 'colette.barthelemy@abi.fr', 'CDI', NULL, NULL, 62500, NULL, '35, rue Alix Bazin\n46521 Turpin'),
(11, 'VéroniqueHo', 'Véronique', 'Véronique', 'Hoareau', 'Respoonsable du département développement', '0642313761', 'véronique.hoareau@abi.fr', 'CDI', NULL, NULL, 68500, NULL, '5, boulevard de Lagarde\n18 512 LeroyBourg'),
(12, 'HortenseBo', 'Hortense', 'Hortense', 'Bouchet', 'Secrétaire technique', '0686787562', 'hortense.bouchet@abi.fr', 'CDI', NULL, NULL, 42500, NULL, '6, rue Renaud\n86 084 Guyot-sur-Cordier'),
(13, 'MarcelGu', 'Marcel', 'Marcel', 'Guillot', 'Technicien support', '0647026646', 'marcel.guillot@abi.fr', 'CDI', NULL, NULL, 35500, NULL, 'avenue Jean Barbe\n19648 Meunier-sur-Besson'),
(14, 'ÉmileGu', 'Émile', 'Émile', 'Guillot', 'Technicien support', '0618105072', 'Émile.guillot@abi.fr', 'CDD', NULL, NULL, 35500, NULL, '39, impasse de Millet\n14 884 Pinto'),
(35, 'AstridCo', 'Astrid', 'Astrid', 'Colas', 'Commercial', '0697896441', 'astrid.colas@abi.fr', 'CDD', NULL, NULL, 43600, NULL, '3, chemin de Seguin\n59 561 Bodin-sur-Charles'),
(36, 'ZoéLe', 'Zoé', 'Zoé', 'Lefebvre', 'Commercial', '0629226416', 'zoé.lefebvre@abi.fr', 'CDI', NULL, NULL, 41300, NULL, 'chemin de Jacques\n63481 Boulayboeuf'),
(37, 'MargauxLa', 'Margaux', 'Margaux', 'Lamy', 'Scrum master', '0667815309', 'margaux.lamy@abi.fr', 'CDD', NULL, 'Architecte', 39500, NULL, '35, place de Bouvier\n38 283 Bernier-sur-Mer'),
(57, 'DanielBl', 'Daniel', 'Daniel', 'Blin', 'Développeur', '0634459063', 'daniel.blin@abi.fr', 'CDD', NULL, 'Développeur Web', 26900, NULL, '94, place de Lemoine\n27228 Godardboeuf'),
(58, 'TimothéeRo', 'Timothée', 'Timothée', 'Roche', 'Développeur', '0647679627', 'timothée.roche@abi.fr', 'CDI', NULL, 'Architecte', 27200, NULL, '4, place Tristan Vincent\n30813 Leleu-les-Bains'),
(59, 'ThibaultMe', 'Thibault', 'Thibault', 'Merle', 'Développeur', '0616326681', 'thibault.merle@abi.fr', 'CDI', NULL, 'Architecte', 26900, NULL, 'place Alfred Valette\n37 780 Colas'),
(60, 'DenisCh', 'Denis', 'Denis', 'Chauvet', 'Scrum master', '0601817490', 'denis.chauvet@abi.fr', 'Stage', NULL, 'Designer', 34900, NULL, '986, rue de Michaud\n38 781 Guillon-sur-Mer'),
(61, 'MartinJa', 'Martin', 'Martin', 'Jacquet', 'Développeur', '0657376062', 'martin.jacquet@abi.fr', 'CDD', NULL, 'Designer', 26800, NULL, '7, rue Leger\n03617 Masson'),
(62, 'ArthurPi', 'Arthur', 'Arthur', 'Pineau', 'Développeur', '0606376524', 'arthur.pineau@abi.fr', 'Stage', NULL, 'Développeur Web', 28300, NULL, '81, boulevard Xavier Marin\n57288 Regniernec'),
(63, 'JeanWa', 'Jean', 'Jean', 'Wagner', 'Développeur', '0635636329', 'jean.wagner@abi.fr', 'CDI', NULL, 'Designer', 29200, NULL, '2, place de Bonnet\n02998 Etiennedan'),
(64, 'EmmanuelWe', 'Emmanuel', 'Emmanuel', 'Weiss', 'Développeur', '0669363901', 'emmanuel.weiss@abi.fr', 'CDD', NULL, 'Designer', 29900, NULL, '39, boulevard Bouvier\n39 529 Allard'),
(65, 'RichardNo', 'Richard', 'Richard', 'Normand', 'Développeur', '0608978923', 'richard.normand@abi.fr', 'Intérim', NULL, 'Développeur Web', 30300, NULL, 'rue Thibault\n50498 Arnaud'),
(66, 'CharlotteCo', 'Charlotte', 'Charlotte', 'Coulon', 'Développeur', '0601825672', 'charlotte.coulon@abi.fr', 'CDD', NULL, 'Développeur BDD', 32000, NULL, '23, boulevard Sanchez\n54317 Pierre-la-Forêt'),
(67, 'AstridRi', 'Astrid', 'Astrid', 'Richard', 'Scrum master', '0648134865', 'astrid.richard@abi.fr', 'CDD', NULL, 'Développeur BDD', 33900, NULL, '70, boulevard Hebert\n55 992 Coste-sur-Legros'),
(68, 'AlainMa', 'Alain', 'Alain', 'Martin', 'Développeur', '0649066018', 'alain.martin@abi.fr', 'Intérim', NULL, 'Designer', 28300, NULL, '65, avenue Honoré Huet\n15 887 Barbe'),
(69, 'ArthurLe', 'Arthur', 'Arthur', 'Leconte', 'Développeur', '0626901666', 'arthur.leconte@abi.fr', 'CDD', NULL, 'Designer', 31800, NULL, '64, avenue de Torres\n27 806 Marie'),
(70, 'ClémenceBe', 'Clémence', 'Clémence', 'Besnard', 'Développeur', '0691174619', 'clémence.besnard@abi.fr', 'CDI', NULL, 'Designer', 32100, NULL, '141, impasse Vincent\n80884 Rousseau'),
(71, 'DominiqueBe', 'Dominique', 'Dominique', 'Berthelot', 'Développeur', '0669017196', 'dominique.berthelot@abi.fr', 'Stage', NULL, 'Designer', 25400, NULL, 'avenue Patrick Martins\n34171 Bonnet'),
(72, 'FrançoisePa', 'Françoise', 'Françoise', 'Pascal', 'Développeur', '0697994061', 'françoise.pascal@abi.fr', 'CDD', NULL, 'Designer', 35000, NULL, '18, avenue Laurent Evrard\n74282 Lucas-la-Forêt'),
(73, 'PaulinePa', 'Pauline', 'Pauline', 'Parent', 'Développeur', '0637928805', 'pauline.parent@abi.fr', 'CDI', NULL, 'Designer', 30100, NULL, '23, impasse de Michaud\n51 781 Letellier'),
(74, 'GillesKl', 'Gilles', 'Gilles', 'Klein', 'Développeur', '0654772223', 'gilles.klein@abi.fr', 'Stage', NULL, 'Développeur Web', 33300, NULL, '81, rue Auguste Lebreton\n74343 Hamel-sur-Torres'),
(75, 'ÉricLe', 'Éric', 'Éric', 'Leveque', 'Développeur', '0656266397', 'Éric.leveque@abi.fr', 'CDI', NULL, 'Designer', 27700, NULL, '656, place Meunier\n57385 Legros');
...
--
-- Table structure for table `contract_origin`
--
...
--
-- Indexes for table `contract_origin`
--
...
--
-- AUTO_INCREMENT for table `contract_origin`
--
ALTER TABLE `contract_origin`
...
--
-- Constraints for table `contract_origin`
--
ALTER TABLE `contract_origin`
