    ...
    <table id="listProject" class="table table-hover table-bordered">
        ...
        <?php foreach ($projects as $project) : ?>
            <tr id="<?= $project->getId() ?>">
                ...
                <td><?= $project->getDateEnd() ? $project->getDateEnd()->format("d/m/Y") : "En cours" ?></td>
            </tr>
        <?php endforeach; ?>
        </tbody>
    </table>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" id="form_modal">
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <div class="d-flex flex-column align-content-center">
                                    ...
                                    <button class="btn btn-duck mt-3" id="addCollaborator">Ajouter un collaborateur
                                    </button>
                                </div>
                            </div>
                        </div>
                        ...
                        <button type="button" class="btn btn-danger delete" id="deleteProject">Supprimer</button>
                    </form>
                </div>
            </div>
        </div>
